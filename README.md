...
The input of this scraper should be JSON containing the list of pages on Tiktok Hashtag that should be visited. Possible fields are:

- `search`: (Optional) (String) List of Tiktok Hashtag keywords. You can type any hashtag in here to search. URLs.
